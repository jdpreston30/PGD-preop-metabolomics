...
All raw data files (.mzXML format) and feature tables analyzed in this study are available at the NIH Common Fund’s National Metabolomics Data Repository (NMDR), Metabolomics Workbench. The dataset has been assigned Project ID PR002742, Study ID ST004328, and is scheduled for release on 2026-10-31. It can be accessed directly via its DOI: http://dx.doi.org/10.21228/M87549.
