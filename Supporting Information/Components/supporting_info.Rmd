...
\textbf{Expanded Metabolomics Methods and Other Technical Details} \dotfill 8-10

\quad \textit{Sample Collection and Processing} \dotfill 8

\quad \textit{Metabolomics Profiling with LC-MS} \dotfill 8

\quad \textit{Feature Extraction, Annotation, and Identification} \dotfill 8-9

\quad \textit{Data Structuring and Transformation} \dotfill 9

\quad \textit{Metabolomics Statistical Analysis and Data Visualization} \dotfill 9-10

\quad \textit{References} \dotfill 10


\textbf{References} \dotfill 11
